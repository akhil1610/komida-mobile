...
{	
	...
	//	ln.getLanguage();
		...
		if(typeof(Storage) !== undefined) {
			...
			if(sessionStorage.LANGUAGE !== undefined){
				//console.log("language is defined. it is " +sessionStorage.LANGUAGE);
				ln.language.code = sessionStorage.LANGUAGE;
			} else{
				ln.language.code = "en";
				//console.log("language is undefined. Set to " + ln.language.code);
			}
        ...
        ({			
            ...
            useCookie: false,
            fallbackLng: 'en',			
            resGetPath: 'locales/__ns__.__lng__.json?V=1.0'
    ...
    {		
		ln.language.local = navigator.language;
		ln.language.code = ln.nativeLanguageNameToISOCode(navigator.language);
		ln.language.international = ln.nativeLanguageNameToEnglishName(navigator.language);	
